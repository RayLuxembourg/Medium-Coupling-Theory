...
- A new section is added to `phase2/mathematical-framework.md`: add a cross-reference from the relevant README section. If the new section addresses a phenomenon listed in Section 3, add a "See [Section N](phase2/...)" link. If it is a new testable prediction, add it to the predictions table in Section 5.
...
- Internal refactors within phase2/ that don't change what is derived or predicted.
- Fixing typos or formatting in phase2/ only.
...
```markdown
See [Section 5](phase2/mathematical-framework.md#5-derivation-mass-quantization-from-angular-momentum) for the quantization argument.
```
